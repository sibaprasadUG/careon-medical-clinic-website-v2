...
export const ServiceManager: React.FC = () => {
  ...
  const handleDeleteService = () => {
    ...
    DataAccessLayer.deleteService(deleteConfirm.id, currentUser);
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="flex items-center justify-between gap-3 pt-4 border-t border-slate-100">
                <div>
                  {editingService?.id && (
                    <button
                      type="button"
                      onClick={() => setDeleteConfirm(editingService as Service)}
      ...
      <ConfirmationDialog
        ...
        message="This will permanently remove this clinical service from the clinic database. Any linked appointments will retain historical records. Are you sure?"
